...
class AIHybridMACDStrategy(IStrategy):
    """
    ...
    ai_thres_buy = DecimalParameter(0.0, 0.5, default=0.008, space='buy', optimize=True)
    ai_thres_sell = DecimalParameter(-0.5, 0.0, default=-0.388, space='sell', optimize=True)

    buy_cci = IntParameter(low=-700, high=0, default=-50, space='buy', optimize=True)
    sell_cci = IntParameter(low=0, high=700, default=50, space='sell', optimize=True)
