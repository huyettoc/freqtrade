...
from freqtrade.strategy import CategoricalParameter, DecimalParameter, IStrategy, IntParameter, BooleanParameter
...
class Generate1CrossSwingStrategy(IStrategy):
    minimal_roi = {"14400": -1}
