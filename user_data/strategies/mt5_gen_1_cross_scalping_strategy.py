...
class MT5Gen1CrossScalpingStrategy(IStrategy):
    minimal_roi = {"14400": -1}
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        try:
            ...
            logger.debug(f"Exception during populate_entry_trend: {e}")
    ...
    def populate_exit_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        try:
            ...
            logger.debug(f"Exception during populate_exit_trend: {e}")
        return dataframe
